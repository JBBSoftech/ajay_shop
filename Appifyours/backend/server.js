...
// MongoDB connection
mongoose.connect(process.env.MONGODB_URI || 'mongodb://localhost:27017/ajay_shop_app', {
...
app.get('/api/app-config', async (req, res) => {
  try {
    ...
    const config = {
      adminId: '69528b60122de128433b64c4',
      shopName: 'Ajay shop',
...
app.listen(PORT, () => {
  console.log(`Ajay shop Backend Server running on port ${PORT}`);
});
